...
class List:
    ...
    def __getitem__(self, i):
        ...
        values = deepcopy(self._values[i])
    ...
    def remove_front(self):
        ...
        value = self._values.remove(self._values[0])
    ...
    def split(self):
        ...
        target1 = List()
        target2 = List()
        #x = len(self._values) // 2
        y = 0
        even_limit = (len(self._values) // 2)
        odd_limit = 1 + len(self._values) // 2
