...
class List:
    ...
    temp    Parameters:
        ...
        # Your code here
        temp = []
        temp.append(deepcopy(self._values[i]))
        temp.append(deepcopy(self._values[j]))
        self._values[i] = temp.pop(1)
        self._values[j] = temp.pop(0)
    ...
    def prepend(self, value):
        ...
        """
        # Your code here
        value = self._values.insert(0, value)
        return
